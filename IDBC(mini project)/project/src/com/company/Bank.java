...
public class Bank {
    ...
    public void  menu(int custId) throws SQLException {
        ...
        while (status){
            ...
            switch (choose) {
                ...
                case 2:
                    String getBalance = "select opening_balance from bank_account where customerId = " + custId;
                    Statement statement = con.createStatement();
                    ResultSet resultSet = statement.executeQuery(getBalance);
                    while (resultSet.next()) {
                       System.out.println("Account Balance :  " + resultSet.getInt("opening_balance"));
                    }
                    break;

                case 3:
                    String getBalance1 = "select opening_balance from bank_account where customerId = " + custId;
                    Statement statement1 = con.createStatement();
                    ResultSet resultSet1 = statement1.executeQuery(getBalance1);
                    while (resultSet1.next()) {
                        int currBalance = resultSet1.getInt("opening_balance");
                        int updateBalance = account.withdrawal(currBalance , custId);

                        String updateBalanceQuary = "update bank_account set opening_balance=" + updateBalance + " where customerId=" + custId;
                ...
                case 4:
                    String getBalance2 = "select opening_balance from bank_account where customerId = " + custId;
                ...
                case 5:
                    String getBalance3 = "select opening_balance from bank_account where customerId = " + custId;
                    Statement statement3 = con.createStatement();
                    ResultSet resultSet3 = statement3.executeQuery(getBalance3);
                    while (resultSet3.next()) {
                        int currBalance = resultSet3.getInt("opening_balance");
                        int updateBalance = account.transfer(currBalance);
                ...
                case 6:
                    String getBalance4 = "select opening_balance from bank_account where customerId = " + custId;
                    Statement statement4 = con.createStatement();
                    ResultSet resultSet4 = statement4.executeQuery(getBalance4);
                    while (resultSet4.next()) {
                        int currBalance = resultSet4.getInt("opening_balance");
                        account.interest(currBalance ,custId);
                    }
                    break;

                case 7:
                    String recentTransaction = "select * from bank_transaction where customerId= "+custId+" limit = 10";
    ...
    public void createAcount() throws SQLException {
        ...
        String bankQuery = "insert into bank_account (accNumber,opening_balance,acc_type,customerId) values('" + accountNo + "'," + balance + ",'" + type + "'," + id + ")";
